...
func damage_received(value: float): #funcion que saca vida cuando entra el bullet
	life -= value
	print("life: ", life) #vamos viendo la vida en consola
	if life <= 0: queue_free() #cuando recibe el daño <= 0 desaparece y lo cambiamos arriba
